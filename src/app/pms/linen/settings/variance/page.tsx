...
export default function VarianceSettingsPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl mx-auto pb-20 space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900 dark:text-slate-100 uppercase tracking-tight">Setting — Variance Thresholds</h1>
