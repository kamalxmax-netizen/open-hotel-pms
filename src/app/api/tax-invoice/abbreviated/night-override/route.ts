...
import { setNightOverride } from "@/lib/abbreviated-tax-invoice/service";
...
const bodySchema = z.object({
  ...
  night_date: z.string().regex(DATE_RE),
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await setNightOverride(actor.supabase, {
      entryId: parsed.data.entry_id,
      nightDate: parsed.data.night_date,
