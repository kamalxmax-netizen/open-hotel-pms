import { adminForceClearAlert, requireAlertsAdminAccess } from "@/lib/alerts/service";
...
export async function POST(request: NextRequest) {
  ...
  try {
    const result = await adminForceClearAlert(auth.supabase, auth.actor.userId, parsed.data.daily_state_id, parsed.data.note);
