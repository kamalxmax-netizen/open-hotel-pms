import { requireAlertsReadAccess, snoozeAlert } from "@/lib/alerts/service";
...
export async function POST(request: NextRequest) {
  ...
  try {
    const row = await snoozeAlert(auth.supabase, parsed.data.daily_state_id, parsed.data.note);
