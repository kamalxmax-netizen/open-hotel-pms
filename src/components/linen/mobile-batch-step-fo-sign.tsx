...
export function MobileBatchStepFoSign({ batchId, items, onDone, onBack }: MobileBatchStepFoSignProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden mb-24">
            <div className="p-5 border-b border-slate-100 bg-slate-50">
                <h2 className="text-xl font-bold text-slate-900 font-thai">4. FO เซ็นรับจบ</h2>
